...
# Template pode receber parametros, que são as variasões de massa de teste. Ele conta os parametros e cria a quantidade de testes igual a quantidade de arametros. 
