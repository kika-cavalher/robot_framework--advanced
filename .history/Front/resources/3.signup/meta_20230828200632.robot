...
Signup With Short Pass
    ...
    # essa lista de password )que vai mudar no campo que tem a variavel está definido no arquivo Signups e gera varios testes mudando somente esse mapo com a opção template
