...
Signup With Short Pass
    ...
    #Create dictionary é a keyword que serve para deficir que essa massa é uma json(uma lista).
    ${user}                                         Create Dictionary
    ...                                             name=Erica                                                 lastname=Cavalher
    ...                                             email=erica.cavalher@gmail.com                             password=${short_pass}
    # essa lista de password )que vai mudar no campo que tem a variavel criadaestá definido no arquivo Signups e gera varios testes mudando somente esse mapo com a opção template
