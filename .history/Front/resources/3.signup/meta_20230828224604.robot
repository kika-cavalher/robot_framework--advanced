...
# Primeiro Span são os elementos encontrados com o mesmo identificador mas são eles individualmente, @spans é a lista inteira criada acima com os mesmo identificador .
    FOR    ${span}   IN    @{spans}
