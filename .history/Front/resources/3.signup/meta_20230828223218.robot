...
# Primeiro Span com $ é a variavel individual de erro e o @spans é a lista intira criado acima.
    FOR    ${span}   IN    @{spans}
...
# Primeiro juntar tudo em uma lista usando o FOR (assim não precisa ficar fixo o valor podendo usar em outras situações)
#
